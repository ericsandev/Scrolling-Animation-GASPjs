	...
	return (
		<Section id="third" ref={sectionRef}>
			...
			<FireContainer ref={textRef}>
				<Welcome className="yellow">TYPESCRIPT</Welcome>
				<Welcome className="orange">TYPESCRIPT</Welcome>
				<Welcome className="red">TYPESCRIPT</Welcome>
			</FireContainer>

			<FireContainer ref={textRef2}>
				<Welcome id="red" className="yellow">
					NODE.JS
				</Welcome>
				<Welcome className="orange"> NODE.JS</Welcome>
				<Welcome className="red"> NODE.JS</Welcome>
			</FireContainer>
		</Section>
	);
};
