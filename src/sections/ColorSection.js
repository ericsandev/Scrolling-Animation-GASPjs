...
const ColorSection = () => {
	...
	useLayoutEffect(() => {
		...
		let t2 = gsap
			...
			.to(Elem, {
				onStart: updateColor,
				onStartParams: ['#9BB5CE', 'New Things', '155, 181, 206'],
			...
			.to(Elem, {
				onStart: updateColor,
				onStartParams: ['#F9E5C9', 'JOIN US', '249, 229, 201'],
				onReverseComplete: updateColor,
				onReverseCompleteParams: ['#F9E5C9', 'Gold', '249, 229, 201'],
			})
			.to(Elem, {
				onStart: updateColor,
				onStartParams: ['#505F4E', 'ALPHA', '80, 95, 78'],
				onReverseComplete: updateColor,
				onReverseCompleteParams: [
					'#505F4E',
					'Alpine Green',
			...
			.to(Elem, {
				onStart: updateColor,
				onStartParams: ['#574f6f', 'COOL', '87, 79, 111'],
				onReverseComplete: updateColor,
				onReverseCompleteParams: [
					'#574f6f',
					'Deep Purple',
